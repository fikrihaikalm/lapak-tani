    ...
    displayResults(data) {
        ...
        if (data.products && data.products.length > 0) {
            ...
            data.products.forEach(product => {
                html += `
                    <a href="${product.url}" class="flex items-center p-2 hover:bg-gray-50 rounded">
        ...
        if (data.articles && data.articles.length > 0) {
            ...
            data.articles.forEach(article => {
                html += `
                    <a href="${article.url}" class="flex items-center p-2 hover:bg-gray-50 rounded">
        ...
        if (data.farmers && data.farmers.length > 0) {
            ...
            data.farmers.forEach(farmer => {
                html += `
                    <a href="${farmer.url}" class="flex items-center p-2 hover:bg-gray-50 rounded">
