...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">Kelola produk dari semua petani</p>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button data-delete="{{ route('admin.products.destroy', $product->id) }}" 
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        ...
                        <p class="text-sm text-gray-500">Produk dari petani akan ditampilkan di sini.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
